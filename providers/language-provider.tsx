...
const translations: Record<Language, Record<string, string>> = {
  en: {
    "hero.tagline": "Scan, Generate, Customize - The Ultimate QR Code Solution.",
    "cta.googlePlay": "Download on Google Play",
    ...
    "features.theme.description": "Choose between light and dark mode for comfortable scanning in any environment.",
    ...
    "features.interface.description": "Navigate effortlessly with our clean, intuitive, and user-friendly interface.",
    "screenshots.title": "App Screenshots",
    "screenshots.subtitle": "Take a closer look at our app's sleek design and intuitive interface.",
    ...
    "company.mission": "Our mission is to create applications that make people's lives easier and more productive.",
    "company.vision":
  ...
  es: {
    "hero.tagline": "Escanea, Genera, Personaliza - La solución definitiva de códigos QR.",
    "cta.googlePlay": "Descargar en Google Play",
    ...
    "features.theme.description": "Elige entre modo claro y oscuro para un escaneo cómodo en cualquier entorno.",
    ...
    "features.interface.description": "Navega sin esfuerzo con nuestra interfaz limpia, intuitiva y fácil de usar.",
    ...
    "reviews.cta.text": "¿Te gusta nuestra aplicación? ¡Comparte tu experiencia con otros!",
  ...
  fr: {
    "hero.tagline": "Scannez, Générez, Personnalisez - La solution QR Code ultime.",
    "cta.googlePlay": "Télécharger sur Google Play",
    "cta.appStore": "Télécharger sur App Store",
    ...
    "features.interface.description": "Naviguez sans effort avec notre interface propre, intuitive et conviviale.",
    "screenshots.title": "Captures d'Écran",
    "screenshots.subtitle": "Regardez de plus près le design élégant et l'interface intuitive de notre application.",
    ...
    "reviews.cta.text": "Vous aimez notre application ? Partagez votre expérience avec d'autres !",
  ...
  de: {
    "hero.tagline": "Scannen, Generieren, Anpassen - Die ultimative QR-Code-Lösung.",
    "cta.googlePlay": "Bei Google Play herunterladen",
    ...
    "reviews.cta.text": "Lieben Sie unsere App? Teilen Sie Ihre Erfahrung mit anderen!",
  ...
  zh: {
    ...
    "cta.googlePlay": "在Google Play上下载",
    "cta.appStore": "在App Store上下载",
    "features.title": "强大功能",
    "features.subtitle": "探索使我们的二维码扫描器和生成器成为所有二维码需求的终极解决方案的所有强大功能。",
    "features.scan": "扫描和生成二维码",
    "features.scan.description": "快速扫描任何二维码或为网站、社交媒体等生成自定义代码。",
    "features.customize": "自定义二维码",
    "features.customize.description": "使用自定义颜色、形状，甚至添加您的徽标，让您的二维码脱颖而出。",
    "features.history": "历史记录",
    "features.history.description": "使用我们内置的历史记录跟踪所有扫描和生成的二维码。",
    "features.theme": "明/暗模式",
    "features.theme.description": "选择明暗模式，在任何环境中舒适扫描。",
    "features.feedback": "触觉反馈和声音",
    "features.feedback.description": "通过触觉反馈和声音通知享受更具互动性的体验。",
    "features.language": "多语言支持",
    "features.language.description": "使用我们全面的多语言支持，以您喜欢的语言使用应用程序。",
    "features.interface": "简单直观的界面",
    "features.interface.description": "通过我们干净、直观和用户友好的界面轻松导航。",
    ...
    "team.title": "关于开发团队",
    "team.description": "VNDev Labs是一个充满激情的开发团队，致力于创建创新和用户友好的应用程序。",
    "team.experience": "年经验",
    "team.apps": "开发的应用",
    "team.users": "满意用户",
    "company.title": "关于VNDev Labs",
    "company.description": "VNDev Labs是一家前瞻性的软件开发公司，专注于创建尖端移动应用程序。",
    "company.mission": "我们的使命是创建使人们的生活更轻松、更高效的应用程序。",
    "company.vision": "我们相信持续创新、以用户为中心的设计以及在所有工作中提供卓越品质。",
    "reviews.title": "用户评价",
    "reviews.subtitle": "不要只相信我们的话。这是用户对Quick QR Scanner & Generator的评价。",
    "reviews.cta.text": "喜欢我们的应用？与他人分享您的体验！",
    "reviews.cta.button": "写评论",
    "cta.download": "下载应用",
    "cta.subtitle": "加入数百万信任Quick QR Scanner & Generator满足所有二维码需求的用户。立即下载，体验不同！",
  ...
  ja: {
    "hero.tagline": "スキャン、生成、カスタマイズ - 究極のQRコードソリューション。",
    "cta.googlePlay": "Google Playでダウンロード",
    "cta.appStore": "App Storeでダウンロード",
    ...
    "features.customize.description": "カスタムカラー、形状、さらにはロゴを追加して、QRコードを目立たせましょう。",
    "features.history": "履歴ログ",
    "features.history.description": "内蔵の履歴ログで、スキャンおよび生成したすべてのQRコードを追跡します。",
    "features.theme": "ライト/ダークモード",
    "features.theme.description": "どんな環境でも快適にスキャンできるよう、ライトモードとダークモードを選択できます。",
    "features.feedback": "触覚フィードバックとサウンド",
    "features.feedback.description": "触覚フィードバックとサウンド通知でより対話的な体験をお楽しみください。",
    "features.language": "多言語サポート",
    "features.language.description": "包括的な多言語サポートにより、お好みの言語でアプリを使用できます。",
    "features.interface": "シンプルで直感的なインターフェース",
    "features.interface.description":
      "クリーンで直感的、そしてユーザーフレンドリーなインターフェースで簡単に操作できます。",
    "screenshots.title": "アプリのスクリーンショット",
    "screenshots.subtitle": "アプリのスタイリッシュなデザインと直感的なインターフェースをより詳しくご覧ください。",
    ...
    "company.mission": "私たちの使命は、人々の生活をより簡単に、より生産的にするアプリケーションを作ることです。",
    "company.vision":
    ...
    "reviews.cta.text": "私たちのアプリを気に入っていただけましたか？あなたの経験を他の人と共有してください！",
  ...
  ko: {
    ...
    "cta.googlePlay": "Google Play에서 다운로드",
    ...
    "features.customize.description": "맞춤형 색상, 모양, 심지어 로고를 추가하여 QR 코드를 돋보이게 하세요.",
    "features.history": "기록 로그",
    "features.history.description": "내장된 기록 로그로 스캔하고 생성한 모든 QR 코드를 추적하세요.",
    "features.theme": "라이트/다크 모드",
    "features.theme.description": "어떤 환경에서도 편안한 스캔을 위해 라이트 모드와 다크 모드 중에서 선택하세요.",
    "features.feedback": "햅틱 피드백 및 사운드",
    "features.feedback.description": "햅틱 피드백과 사운드 알림으로 더 상호작용적인 경험을 즐기세요.",
    "features.language": "다국어 지원",
    "features.language.description": "포괄적인 다국어 지원으로 선호하는 언어로 앱을 사용하세요.",
    "features.interface": "간단하고 직관적인 인터페이스",
    "features.interface.description": "깔끔하고 직관적이며 사용자 친화적인 인터페이스로 쉽게 탐색하세요.",
    "screenshots.title": "앱 스크린샷",
    "screenshots.subtitle": "앱의 세련된 디자인과 직관적인 인터페이스를 자세히 살펴보세요.",
    ...
    "company.mission": "우리의 사명은 사람들의 삶을 더 쉽고 생산적으로 만드는 애플리케이션을 만드는 것입니다.",
    "company.vision":
    ...
    "reviews.cta.text": "우리 앱이 마음에 드시나요? 다른 사람들과 경험을 공유하세요!",
  ...
  vi: {
    ...
    "cta.googlePlay": "Tải xuống trên Google Play",
    "cta.appStore": "Tải xuống trên App Store",
    ...
    "features.theme.description": "Chọn giữa chế độ sáng và tối để quét thoải mái trong mọi môi trường.",
    "features.feedback": "Phản hồi xúc giác & Âm thanh",
    "features.feedback.description": "Tận hưởng trải nghiệm tương tác hơn với phản hồi xúc giác và thông báo âm thanh.",
    ...
    "screenshots.subtitle": "Xem kỹ hơn thiết kế thanh lịch và giao diện trực quan của ứng dụng chúng tôi.",
    ...
    "reviews.subtitle": "Đừng chỉ tin lời chúng tôi. Đây là những gì người dùng nói về Quick QR Scanner & Generator.",
    "reviews.cta.text": "Yêu thích ứng dụng của chúng tôi? Chia sẻ trải nghiệm của bạn với người khác!",
