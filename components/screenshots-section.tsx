  ...
  useEffect(() => {
    ...
    if (autoplay) {
      interval = setInterval(() => {
        setActiveIndex((prevIndex) => (prevIndex === screenshots.length - 1 ? 0 : prevIndex + 1))
      }, 3000)
    }
    ...
    <section id="screenshots" className="section-padding overflow-hidden">
      <div className="container mx-auto container-padding">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">{t("screenshots.subtitle")}</p>
        </div>
          ...
          <div className="overflow-hidden rounded-3xl shadow-xl">
            <div className="relative w-full h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 text-white">
                <p className="text-center font-medium">{screenshots[activeIndex].alt}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center gap-6">
            {visibleScreenshots.map((screenshot, idx) => {
              ...
              return (
                ...
                >
                  <div className="absolute inset-0 -z-10 rounded-3xl bg-gradient-to-r from-blue-500/20 to-purple-600/20 blur-xl" />
                  <div className={`relative ${isCenter ? "h-[600px] w-[300px]" : "h-[500px] w-[250px]"}`}>
                    <Image
